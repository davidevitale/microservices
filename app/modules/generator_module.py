...
from app.models.input_schema import Subdomain, ArchitectureInput
from app.models.output_schema import (
    MicroserviceSpec, Requirement, EventDefinition, APIEndpoint,
    ServiceDependency, RequirementType, RequirementPriority
)
...
class SpecificationGeneratorPipeline(dspy.Module):
    ...
    def forward(self, subdomain: Subdomain, technical_stack: Dict[str, str], global_constraints: Dict[str, str]) -> Dict[str, Any]:
        """
        ...
        spec_data = {
            ...
            "functional_requirements": self._parse_requirements(result.functional_requirements, RequirementType.FUNCTIONAL),
            "non_functional_requirements": self._parse_requirements(result.non_functional_requirements, RequirementType.NON_FUNCTIONAL),
            ...
            "infrastructure_requirements": self._parse_json_safe(result.infrastructure_requirements),
